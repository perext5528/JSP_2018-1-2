    ...
    <TR>
        <TD ALIGN=CENTER>
            <TABLE WIDTH=450 CELLSPACING=0 CELLPADDING=0 TOPMARGIN=0 LEFTMARGIN=0>
                <TR>
                    <TD ALIGN=CENTER HEIGHT=30><BR>총 <B><%=rows%>
                    </B>개의 주소가 검색되었습니다.
                    </TD>
                </TR>
                <TR>
    ...
    <TR>
        <TD ALIGN=CENTER>
            <TABLE WIDTH=400 CELLSPACING=0 CELLPADDING=0 TOPMARGIN=0 LEFTMARGIN=0>
                ...
                <TR>
                    <TD>
                        <A HREF="javascript:InputAddress('<%=zcode%>','<%=sido%>','<%=gugun%>','<%=dong%>','<%=frm%>')"><%=Address%>
                        </A>
                    </TD>
                </TR>
                <TR>
                    ...
                    <TR>
                        <TD ALIGN=CENTER>
                            ...
                            <IMG SRC="../images/btn_search.gif" BORDER=0 ALIGN=ABSMIDDLE STYLE=CURSOR:HAND
                                 onclick="javascript:CheckForm(AddressSearch2)"><BR><BR>
