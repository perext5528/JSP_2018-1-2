...
<FORM NAME="BeMember" METHOD=POST
    ...
    <TABLE WIDTH=620 BORDER=1 CELLSPACING=0 CELLPADDING=2 ALIGN=CENTER>
        ...
        <TR>
            ...
            <TD WIDTH=500>
                <INPUT TYPE=TEXT NAME="ZipCode1" SIZE=3 MAXLENGTH=3 readonly
                       onclick="javascript:alert('우편번호 검색버튼을 이용하세요.')"> -
                <INPUT TYPE=TEXT NAME="ZipCode2" SIZE=3 MAXLENGTH=3 readonly
                       onclick="javascript:alert('우편번호 검색버튼을 이용하세요.')"><BR>
                <INPUT TYPE=TEXT NAME="UserAddress1" SIZE=45 MAXLENGTH=110" readonly
                       onclick="javascript:alert('우편번호 검색버튼을 이용하세요.')">
                <IMG SRC="../images/btn_post_3.gif" BORDER=0 ALIGN=ABSMIDDLE STYLE=CURSOR:HAND
                     onclick="javascript:AddressSearch('AddressSearch_1.jsp','BeMember', 'SearchAddress', 520, 220, 'yes')"><BR>&nbsp;
                나머지 주소
...
<TABLE WIDTH=620 HEIGHT=50 BORDER=0 CELLSPACING=1 CELLPADDING=1 ALIGN=CENTER>
    ...
    <TR ALIGN=CENTER>
        <TD>
            ...
            <IMG SRC="../images/btn_mb_cancel_3.gif"
